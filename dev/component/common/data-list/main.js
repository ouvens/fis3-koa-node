define('data-list', function(require, exports, module) {

  var list1 = require('data-list/list1.tpl'),
      list2 = require('data-list/list2.tpl'),
      list3 = require('data-list/list3.tpl');
  var labelList = {
      $el: $('#container'),
