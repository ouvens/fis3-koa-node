define('pages/index/main', function(require, exports, module) {
  ...
  var tpl = require('index/index.tpl');
...
;define('index/index.tpl', function(require, exports, module) {
...
;define('slider/index.tpl', function(require, exports, module) {
  ...
  return  function (it, opt) {
   ...
   for ( var i = 0 ,len = slider.length; i < len; i++){ loop.index = i+1; item = slider[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('page-menu/index.tpl', function(require, exports, module) {

  return  function (it, opt) {
      it = it || {};
      with(it) {
          var _$out_= [];
          _$out_.push('<li> <ul class="page"> '); var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = pageMenu.length; i < len; i++){ loop.index = i+1; item = pageMenu[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('banner-2/index.tpl', function(require, exports, module) {
  ...
  return  function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
           var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = banner2.length; i < len; i++){ loop.index = i+1; item = banner2[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('banner-3/index.tpl', function(require, exports, module) {

  return  function (it, opt) {
      it = it || {};
      with(it) {
          var _$out_= [];
          _$out_.push('<ul class="ui-grid-trisect"> '); var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = banner3.list.length; i < len; i++){ loop.index = i+1; item = banner3.list[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('panel-3/index.tpl', function(require, exports, module) {

  return  function (it, opt) {
      it = it || {};
      with(it) {
          var _$out_= [];
          _$out_.push('<h2 class="ui-arrowlink" data-href="',  panel3.url , '"> ',  panel3.title , '<span class="ui-panel-subtitle">',  panel3.total || 0 , '条</span></h2><ul class="ui-grid-trisect"> '); var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = panel3.list.length; i < len; i++){ loop.index = i+1; item = panel3.list[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('tab-recmend/index.tpl', function(require, exports, module) {
  ...
  return  function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
           var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = tabRecmend.list.length; i < len; i++){ loop.index = i+1; item = tabRecmend.list[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('tab-more/index.tpl', function(require, exports, module) {
  ...
  return  function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
           var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = tabMore.list.length; i < len; i++){ loop.index = i+1; item = tabMore.list[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
...
;define('label-list/index.tpl', function(require, exports, module) {
  ...
  return  function (it, opt) {
      ...
      with(it) {
          var _$out_= [];
           var loop = {index: 1, first: true};var item;
   for ( var i = 0 ,len = keywords.length; i < len; i++){ loop.index = i+1; item = keywords[i]; if(loop.index === 1){ loop.first === true;}else{ loop.first = false; }
