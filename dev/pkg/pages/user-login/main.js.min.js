define('pages/user-login/main', function(require, exports, module) {

  /**
   * main
   * @require 'pages/user-login/index.scss' // 无需在页面中控制 css
   */
  
  var userForm = require('login-form');
  
  var tpl = require('user-login/index.tpl');
...
;define('user-login/index.tpl', function(require, exports, module) {
...
;define('login-form/index.tpl', function(require, exports, module) {

  return  function (it, opt) {
      it = it || {};
      with(it) {
          var _$out_= [];
          _$out_.push('<div class="ui-placehold-img"> <span></span></div><div class="ui-banner"> <p class="ui-txt-white ui-txt-left">',  data.date , '</p> <p class="ui-txt-white ui-txt-right">',  data.cate , ' ', data.place, ' ', data.subType, '</p></div>');
        return _$out_.join('');
      }
  }
